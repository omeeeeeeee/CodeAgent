...
async def click_okay(state: State, config: RunnableConfig) -> State:
    """Click okay - disabled node."""
    logging.info("Node 7: Skipping disabled node - Click okay")
...
async def click_yes(state: State, config: RunnableConfig) -> State:
    """Click yes - disabled node."""
    logging.info("Node 10: Skipping disabled node - Click yes")
